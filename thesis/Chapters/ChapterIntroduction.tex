...
\begin{inparaenum}[(i)]
    ...
    \item 
        We provide implementations for important graph based algorithms based on the proposed framework.
        All data structures and algorithm are implemented in fast C++.
    \item All algorithms and datastructures can be used from Python for rapid prototyping.
