...
\subsection{Graphs}
    ...
    \begin{figure}[H]
        ...
        \begin{tikzpicture}[scale=0.75,transform shape]
            \begin{umlpackage}{VIGRAGraphClasses}
        ...
        \end{tikzpicture}
        \caption{
        UML class diagram of VIGRAS GridGraph
        }\label{fig:uml_lemon_grid_graph}
    \end{figure}
    ...
    \begin{center}
        \begin{tikzpicture}[scale=0.5,transform shape]
            \begin{umlpackage}{VIGRA Graph Classes}
                \umlclass[x=10.5,y=0,template=Graph]{MergeGraphAdpator}
                {
