...
\begin{center}
    \begin{tikzpicture}
        ...
        \umlclass[x=9,y=3,template=MergeGraph]{ClusterOperatorInterface}
        {
        ...
        \umldep[geometry=-|-]{MergeGraphAdpator}{ClusterOperatorInterface}
        \umldep[geometry=-|-]{ClusterOperatorInterface}{HierarchicalClustering}
