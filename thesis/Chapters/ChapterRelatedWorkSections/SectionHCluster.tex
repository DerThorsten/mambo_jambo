...
region in the image.
The leafs in the tree are the atomic units of the image (e.g. pixel, super-pixels or super-voxels)
...
Edge detectors as the gradient magnitude,gPb \citep{marie_2008_cvpr}  or learned
...
generated by a HSO can be encoded in the saliency map (see \cref{fig:fig:ucm_saliency} ).
The formulas and the notation of \crefrange{eq:ucm_hco_eq_0}{eq:ucm_hco_eq_2}
have been taken from \citep{ arbelaez_2006_cvpr}.


\citet{iglesias_2013} improve segmentation results with 
