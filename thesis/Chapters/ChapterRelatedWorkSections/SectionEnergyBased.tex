...
if some capacities / energies can be changed. This allows an efficient computation of 
...
An additional set of constraints, \emph{integer constraint} as defined in \cref{eq:integral_constraint}, can be added the LP in \cref{eq:gm_lp}. These constraints turn the LP into an integer LP (I-LP).
